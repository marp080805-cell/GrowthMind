...
export const BLOCKS: BlockDefinition[] = [
  ...
  { type: 'meta.filter_unsponsored_posts', label: 'Filtrar posts não patrocinados', description: 'Remove da lista os posts que já foram patrocinados (verifica FlowAds e Meta Ads)', icon: '🔎', category: 'meta', color: CATEGORY_COLORS.meta, handles: { inputs: ['default'], outputs: ['default'] }, defaultConfig: { source_posts: '{{posts}}' } },
