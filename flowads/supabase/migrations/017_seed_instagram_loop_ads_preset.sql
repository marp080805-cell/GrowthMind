...
VALUES (
  ...
  '[
    ...
    {"id":"n10","type":"logic.if","label":"Anúncio criado?","config":{"value":"true","operator":"=","variable":"success"},"position":{"x":80,"y":1050}},
  ...
  '[
    ...
    {"id":"e11","source":"n10","target":"n08","sourceHandle":"yes","targetHandle":"default"},
