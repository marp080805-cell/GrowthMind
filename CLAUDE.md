...
2. **Finalizar com "Próximo passo:"** com instruções completas e prontas para o usuário, incluindo:
   - Comando exato para atualizar na VPS (com o path correto): `cd /home/user/AdMind/admind && git pull && docker compose build --no-cache && docker compose up -d`
